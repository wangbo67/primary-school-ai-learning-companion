...
export default function Home(){
 ...
 return <main className="book">
  <header className="topbar"><a href="/" className="brand" aria-label="小小语文探险首页"><span className="brand-mark"><BookOpen size={23}/></span>小小语文探险</a><div className="top-right"><span className="edition">一年级 · 第9课</span><a href="/script.html" target="_blank" rel="noreferrer" className="adult-link">给大人的脚本 ↗</a></div></header>
  ...
  {s.step<2?<div className="play-grid">
   <section className="scene-panel" aria-label="乌鸦与水瓶">
    <div className="scene-art"><img src="/crow.png" alt="小乌鸦站在草地上，好奇地望向水瓶"/><span className="crow-speech">{s.step===0?'我好渴呀……':s.stones===6?'谢谢你，我够得着水啦！':'你想到了什么办法？'}</span><Bottle stones={s.step===0?0:s.stones} onClue={s.step===0?clue:undefined}/></div>
